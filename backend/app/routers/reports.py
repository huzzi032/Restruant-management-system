...
def get_monthly_report(
    ...
    report = ReportService.get_monthly_report(db, month, year)
    return report
...
def get_sales_report(
    ...
    report = ReportService.get_sales_report(db, date_from, date_to)
    return report
...
def get_employee_report(
    ...
    report = ReportService.get_employee_report(db, month, year)
    return report
...
def get_dashboard_summary(
    ...
    summary = ReportService.get_dashboard_summary(db)
    return summary
...
def get_profit_loss_report(
    ...
    # Get sales data
    sales_report = ReportService.get_sales_report(db, date_from, date_to)
    ...
    return {
        ...
        "profit_loss": {
            ...
            "profit_margin": round((net_profit / total_sales * 100) if total_sales > 0 else 0, 2)
        }
    }
