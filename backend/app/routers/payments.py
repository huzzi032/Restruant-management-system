...
def create_payment(
    ...
    # If a discount is provided in the payment request, use it. Otherwise use the order's existing discount.
    discount_amount = payment_data.discount_amount if payment_data.discount_amount > 0 else order.discount_amount
